...
import {
  userLocationServicesListAction,
...
const Cards = () => {
  ...
  const userServiceslist = useSelector((state) => state.userLocationServices);
  const { userLocationServicesList } = userServiceslist;

  const addLocation = useSelector((state) => state.userLocationAdd);
  const { LocationAdd } = addLocation;
  ...
  useEffect(() => {
    dispatch(userLocationServicesListAction(selectedLocation));
  ...
  return (
    <>
      ...
      >
        {userLocationServicesList.map((value, index) => {
          return (
            <Grid
              xs={12}
              sm={6}
